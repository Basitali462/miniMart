...
class SelectMultipleImagesButton extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final addItemProvider = Provider.of<AddItemProvider>(context);
    return GestureDetector(
      onTap: () {
        addItemProvider.pickMultipleImages();
      ...
      child: Container(
        ...
        child: FittedBox(
          fit: BoxFit.fill,
          child: Text(
            addItemProvider.multiSelectedImagesName == null || addItemProvider.multiSelectedImagesName.isEmpty
                ? 'Gallery'
                : addItemProvider.multiSelectedImagesName,
